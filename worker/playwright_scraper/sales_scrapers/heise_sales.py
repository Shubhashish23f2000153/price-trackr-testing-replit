...
class HeiseSalesScraper(BaseSalesScraper):
    """Scrapes Heise.de's news feed for sales and deals."""
    
    def __init__(self, user_agent: str):
        super().__init__(user_agent)
        self.url = "https://www.heise.de/news" # German tech news
    ...
    def scrape(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"  -> Found {len(deal_articles)} potential Heise.de articles.")
            ...
            for article in deal_articles:
                ...
                keywords = ["angebot", "deal", "rabatt", "sparen", "günstig", "preis", "sale"]
