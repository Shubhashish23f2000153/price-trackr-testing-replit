...
class AmazonCOMScraper(BaseScraper):
    def extract_data(self, page: Page) -> Dict:
        """Extract data using Playwright for Amazon.com (US)"""
        
        # --- Set locale to en-US ---
        try:
            page.context.set_extra_http_headers({"Accept-Language": "en-US,en;q=0.9"})
        except Exception as e:
            print(f"[AmazonCOM Scraper] Could not set locale: {e}")
        ...
        price_text = ""
        # Price selectors for amazon.com
        ...
        try:
            ...
            print(f"[AmazonCOM Scraper] Could not extract seller details: {e}")
        ...
        try:
            ...
            print(f"[AmazonCOM Scraper] Extracted {len(recent_reviews)} review snippets.")
        except Exception as e:
            print(f"[AmazonCOM Scraper] Could not extract reviews: {e}")
    ...
    def extract_data_fallback(self, html: str) -> Dict:
        ...
        try:
            ...
            if not seller_name:
             ...
             print(f"[AmazonCOM Fallback] Could not extract seller details: {e}")
