...
class MeeshoScraper(BaseScraper):
    def extract_data(self, page: Page) -> Dict:
        ...
        TITLE_SELECTOR = '.Text__StyledText-sc-oo0kvp-0.bFfSno' # This is very specific, likely to break
        PRICE_SELECTOR = '.Text__StyledText-sc-oo0kvp-0.dLSsNI' # This is also specific
        IMAGE_SELECTOR = '.styles__StyledImg-sc-1SXP95N-2.dYFjot'
        # --- End of selectors ---
        
        title = "Unknown Product"
        try:
            # Meesho titles are tricky, may need to find a better selector
    ...
    def extract_data_fallback(self, html: str) -> Dict:
        ...
        title = soup.select_one('.Text__StyledText-sc-oo0kvp-0.bFfSno')
        title_text = title.get_text().strip() if title else "Unknown Product"
        price = soup.select_one('.Text__StyledText-sc-oo0kvp-0.dLSsNI')
