...
class SaturnDEScraper(BaseScraper):
    def extract_data(self, page: Page) -> Dict:
        """Extract data using Playwright for Saturn.de"""
        
        # --- Set locale to de-DE ---
        try:
            page.context.set_extra_http_headers({"Accept-Language": "de-DE,de;q=0.9,en;q=0.8"})
        except Exception as e:
            print(f"[SaturnDE Scraper] Could not set locale: {e}")

        # --- Wait for core elements (same as MediaMarkt) ---
        try:
            ...
            print(f"[SaturnDE Scraper] Timed out waiting for core elements: {e}")
        # --- End Wait ---
        ...
        try:
            ...
            print(f"[SaturnDE Scraper] Could not find title: {e}")
        ...
        try:
            ...
            print(f"[SaturnDE Scraper] Could not find price: {e}")
        ...
        try:
            ...
            print(f"[SaturnDE Scraper] Could not find image: {e}")
        ...
        try:
            ...
            print(f"[SaturnDE Scraper] Could not find description: {e}")
